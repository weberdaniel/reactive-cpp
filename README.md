...
![example 1{caption=Example caption - here's a picture from my recent trip to Wyoming.}](https://github.com/weberdaniel/supervisor-demo/blob/main/doc/images/crash-me-if-you-can.png) 
